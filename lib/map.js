...
function main(argv, cb) {
    ...
    function createIndex() {
        index.init((err) => {
            ...
            //Set Some Args to metatable only if they've been declared by the user- Don't wait for callback as we won't actually use those in this module - they are useful for debug/test/etc modes
            if (tokens !== null) {
