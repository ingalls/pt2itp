...
function checkInterpolationRanges(itps) {
    ...
    return itps.map((itp, i) => {
        ...
        if (lfrom || lto || lfrom !== lto) {
            ...
            const lfromInRange = isInRange(propAtIdx(itps[i - 1], 'carmen:lfromhn'), propAtIdx(itps[i], 'carmen:lfromhn'), propAtIdx(itps[i + 1],'carmen:lfromhn'));
            const ltoInRange = isInRange(propAtIdx(itps[i - 1], 'carmen:ltohn'), propAtIdx(itps[i], 'carmen:ltohn'), propAtIdx(itps[i + 1],'carmen:ltohn'));
        ...
        if (rfrom || rto || rfrom !== rto) {
            // if (!sequence && lfrom > lto && rfrom > rto) {
            const rfromInRange = isInRange(propAtIdx(itps[i - 1], 'carmen:rfromhn'), propAtIdx(itps[i], 'carmen:rfromhn'), propAtIdx(itps[i + 1],'carmen:rfromhn'));
            const rtoInRange = isInRange(propAtIdx(itps[i - 1], 'carmen:rtohn'), propAtIdx(itps[i], 'carmen:rtohn'), propAtIdx(itps[i + 1],'carmen:rtohn'));
