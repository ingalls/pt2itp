...
function generateRange(itp, leftSide, rightSide) {
    ...
    return {
        range: {
            ...
            lstart: isBoth || leftSide ? { number: leftSide.lstart } : null,
            lend:  isBoth || leftSide ? { number: leftSide.lend } : null,
            parityr: isBoth || rightSide ? itp.range.parityr : null,
            rstart: isBoth || rightSide ? { number:  rightSide.rstart } : null,
            rend: isBoth || rightSide ? { number: rightSide.rend } : null
        },
