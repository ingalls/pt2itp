...
function getEdgeSegment(itp, number){
    ...
    const start = turf.point(line.coordinates[rangeOpt.isStart ? 0 : line.coordinates.length - 1]);
...
function assingItpProperties(itp, leftSide, rightSide) {
    ...
    itp.geometry.geometries[0].coordinates = isBoth || leftSide ? leftSide.segment : rightSide.segment;
