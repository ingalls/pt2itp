...
function checkInterpolationRanges(itps) {
    ...
    return itps.map((itp, i) => {
        if (!i || i === (itps.length - 1) || !itp.properties || !itp.rangeOptions) {
        ...
        if (lfrom || lto || lfrom !== lto) {
            // if (sequence && lfrom < lto && rfrom < rto) {
            const lfromInRange = isInRange(itps[i - 1].properties['carmen:lfromhn'][0], itps[i].properties['carmen:lfromhn'][0], itps[i + 1].properties['carmen:lfromhn'][0]);
            const ltoInRange = isInRange(itps[i - 1].properties['carmen:ltohn'][0], itps[i].properties['carmen:ltohn'][0], itps[i + 1].properties['carmen:ltohn'][0]);
        ...
        if (rfrom || rto || rfrom !== rto) {
            // if (!sequence && lfrom > lto && rfrom > rto) {
            const rfromInRange = isInRange(itps[i - 1].properties['carmen:rfromhn'][0], itps[i].properties['carmen:rfromhn'][0], itps[i + 1].properties['carmen:rfromhn'][0]);
            const rtoInRange = isInRange(itps[i - 1].properties['carmen:rtohn'][0], itps[i].properties['carmen:rtohn'][0], itps[i + 1].properties['carmen:rtohn'][0]);
