...
function buildExtRangeSide(itps, diff, isPrev, isLeft) {
    ...
    if (range.properties[fromProp][0] !== undefined && range.properties[toProp][0] !== undefined && number && !isSmall) {
...
function buildExtRangeEnd(itps, leftSide, rightSide, isPrev) {
    ...
    if (leftSide && rightSide && (leftSide.hasNumberChanged || rightSide.hasNumberChanged) && leftSide.idx === rightSide.idx) {
    ...
    } else if (leftSide && rightSide && leftSide.isSmall && !leftSide.number){
        ...
        if (leftSide && leftSide.hasNumberChanged) {
            ...
            itps.splice(spliceIdx, 0, leftSide.range);
        } else if (leftSide && leftSide.isSmall && !leftSide.number) itps[leftSide.idx] = assingItpProperties(itps[leftSide.idx], leftSide, null);
        ...
        } else if (rightSide && rightSide.isSmall && !rightSide.number) itps[rightSide.idx] = assingItpProperties(itps[rightSide.idx], null, rightSide);
    }
