...
function interpolize(splits, argv = {}) {
    ...
    let max = 0; // We ignore 0 addresses, instead depenmding on the dropLow function to fill them in if needed as they are often false postives. (This value was prevously -1)
    let min = Infinity;
    ...
    if (max === 0 && min === Infinity) return join(itps, argv);
