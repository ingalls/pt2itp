...
/**
 * Functions to sort ITP segments into a stable order from lowest -> highest
 * and then potentially buffer out each side to cover a wider range
 * on either end. 
 *
 * Note this does not currently buffer between segments
 */
function buffer(itp) {
