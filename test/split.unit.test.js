...
test('Attach points to line', (t) => {
    ...
    t.deepEqual(Split.attachPoints(network, coords, props), [
          { dist: 0.02893479619937134, location: 0.029558270297311683, props: 1, idx: 1 },
          { dist: 0.02747843094101002, location: 0.09581162246877092, props: 2, idx: 0 },
          { dist: 0.01870470269785991, location: 0.20633234694843797, props: 3, idx: 2 }
    ]);
    t.end();
});
