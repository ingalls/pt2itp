...
test('Interpolize - sequence', (t) => {
    ...
    const res = interpolize(segs[0]);

    t.equals(res.type, 'Feature', 'is feature');

    t.deepEquals(res.properties['carmen:lfromhn'], [
        [0, 3770, 3964, 4152, 4410, 4700, null, 4814, 5216, 5700, 6000, 6414, 7128, 7218, null, 7910, 8442, 8836, 9124, 9608, 10110, 10530, 10968, 11102, 11800, 12200, 12704, 13122, 13530, 14028, 14530, 15114], null
    ], 'lfromhn is as expected');
    t.deepEquals(res.properties['carmen:ltohn'], [
        [11736, 3960, 4122, 4360, 4610, 4730, null, 5118, 5620, 5940, 6318, 6624, 7128, 7218, null, 8120, 8722, 9118, 9430, 9906, 10526, 10962, 11026, 11248, 12114, 12224, 13118, 13452, 14006, 14526, 14832, 20000], null
    ], 'ltohn is as expected');
    t.deepEquals(res.properties['carmen:rfromhn'], [
        [10001, 3789, 3963, 4153, 4409, null, 4721, 4815, 5207, 5709, 6001, 6415, null, 7211, 7713, 7911, 8403, 8721, 9133, 9513, 10117, 10531, 10975, 11101, 11743, 12315, 12701, 13201, 13603, 14021, 14535, 15019], null
    ], 'rfromhn is as expected');
    t.deepEquals(res.properties['carmen:rtohn'], [
        [11739, 3961, 4123, 4345, 4613, null, 4731, 5171, 5705, 5965, 6319, 6609, null, 7519, 7713, 8311, 8715, 9029, 9511, 9815, 10529, 10965, 11023, 11251, 12125, 12619, 12923, 13441, 14015, 14527, 15015, 20001], null
